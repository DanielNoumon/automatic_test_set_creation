/* Embedded copy of FLOW.md so the "How it works" panel renders on file://
   (browsers block fetch() of local files). Keep in sync with FLOW.md.
   Code fences use ::: here to avoid backticks inside this template literal;
   the mini markdown renderer treats ``` and ::: identically.

   NOTE: FLOW.md is generated FROM this file (::: -> ```), so edit here. */
window.FLOW_MD = `
